    ...
    <div id="menuGauche">
     <div id="infosUtil">
        ...
        <ul id="menuList">
           ...
           <li class="smenu">
              <a href="index.php?uc=suiviPaiement&action=suiviPaiementFicheFrais" title="Suivre le paiement d'une fiche de frais visiteur">Suivre le paiement d'une fiche de frais visiteur</a><br />
           </li>
           <li class="smenu">
